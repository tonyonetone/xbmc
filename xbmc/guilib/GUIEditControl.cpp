...
void CGUIEditControl::OnClick()
{
  ...
  switch (m_inputType)
  {
    ...
    case INPUT_TYPE_TIME:
    {
      ...
      if (CGUIDialogNumeric::ShowAndGetTime(time, heading.size() > 0 ? heading : g_localizeStrings.Get(21420)))
      {
    ...
    case INPUT_TYPE_DATE:
    {
      ...
      if (CGUIDialogNumeric::ShowAndGetDate(date, heading.size() > 0 ? heading : g_localizeStrings.Get(21420)))
      {
