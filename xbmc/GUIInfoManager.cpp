...
TIME_FORMAT CGUIInfoManager::TranslateTimeFormat(const std::string &format)
{
  ...
  else if (format == "hh") return TIME_FORMAT_HH;
  else if (format == "mm") return TIME_FORMAT_MM;
  else if (format == "ss") return TIME_FORMAT_SS;
  else if (format == "hh:mm") return TIME_FORMAT_HH_MM;
  else if (format == "mm:ss") return TIME_FORMAT_MM_SS;
  else if (format == "hh:mm:ss") return TIME_FORMAT_HH_MM_SS;
  else if (format == "hh:mm:ss xx") return TIME_FORMAT_HH_MM_SS_XX;
  else if (format == "h") return TIME_FORMAT_H;
  else if (format == "h:mm:ss") return TIME_FORMAT_H_MM_SS;
  else if (format == "h:mm:ss xx") return TIME_FORMAT_H_MM_SS_XX;
  else if (format == "xx") return TIME_FORMAT_XX;
