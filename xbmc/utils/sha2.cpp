...
XBMC::XBMC_SHA2::XBMC_SHA2::XBMC_SHA2()
{
    m_Type = enuSHA_NONE;
...
void XBMC::XBMC_SHA2::XBMC_SHA2::SHA1_Internal_Transform(const sha_word32 *data) {
...
void XBMC::XBMC_SHA2::XBMC_SHA2::SHA256_Internal_Transform(const sha_word32* data) {
...
void XBMC::XBMC_SHA2::XBMC_SHA2::SHA512_Internal_Transform(const sha_word64* data) {
...
void XBMC::XBMC_SHA2::XBMC_SHA2::SHA256_Internal_Last(bool isSha1) {
...
void XBMC::XBMC_SHA2::XBMC_SHA2::SHA512_Internal_Last() {
    sha_word32    usedspace;
...
void XBMC::XBMC_SHA2::XBMC_SHA2::SHA32bit_Update(const sha_byte *data, size_t len, bool isSha1) {
...
void XBMC::XBMC_SHA2::XBMC_SHA2::SHA64bit_Update(const sha_byte *data, size_t len) {
    sha_word32 freespace, usedspace;
...
void XBMC::XBMC_SHA2::XBMC_SHA2::Init(SHA_TYPE type){
    m_Type = type;
    m_boolEnded = false;
...
void XBMC::XBMC_SHA2::XBMC_SHA2::Update(const sha_byte* data, size_t len){
    switch (m_Type){
...
void XBMC::XBMC_SHA2::XBMC_SHA2::End(){
    sha_byte *d = m_digest;
...
const string &XBMC::XBMC_SHA2::XBMC_SHA2::GetHash(SHA_TYPE type, const sha_byte* data, size_t len){
    Init(type);
    Update(data, len);
    End();
    return m_strHash;
...
const char *XBMC::XBMC_SHA2::XBMC_SHA2::HexHash(){
    if (!m_boolEnded) throw std::runtime_error("Unfinished execution!");
    return m_strHash.c_str();
}
const string &XBMC::XBMC_SHA2::XBMC_SHA2::StringHash(){
    if (!m_boolEnded) throw std::runtime_error("Unfinished execution!");
    return m_strHash;
}
const char *XBMC::XBMC_SHA2::XBMC_SHA2::RawHash(int &length){
    if (!m_boolEnded) throw std::runtime_error("Unfinished execution!");
    switch (m_Type){
