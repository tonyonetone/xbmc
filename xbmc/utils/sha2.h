...
namespace XBMC
{
  ...
  public:
      ...
      const char * GetTypeString(){
          switch (m_Type){
              case XBMC_SHA2::enuSHA1   : return "SHA160";
              case XBMC_SHA2::enuSHA224 : return "SHA224";
              case XBMC_SHA2::enuSHA256 : return "SHA256";
              case XBMC_SHA2::enuSHA384 : return "SHA384";
              case XBMC_SHA2::enuSHA512 : return "SHA512";
