...
static KeyMap keyMap[] = {
  ...
  { XBMC_AKEYCODE_ESCAPE     , XBMCK_ESCAPE },
  { XBMC_AKEYCODE_FORWARD_DEL, XBMCK_DELETE },
  { XBMC_AKEYCODE_CTRL_LEFT  , XBMCK_LCTRL },
  { XBMC_AKEYCODE_CTRL_RIGHT , XBMCK_RCTRL },
  { XBMC_AKEYCODE_CAPS_LOCK  , XBMCK_CAPSLOCK },
  { XBMC_AKEYCODE_SCROLL_LOCK, XBMCK_SCROLLOCK },
  { XBMC_AKEYCODE_INSERT     , XBMCK_INSERT },
  { XBMC_AKEYCODE_FORWARD    , XBMCK_FASTFORWARD },
  { XBMC_AKEYCODE_MEDIA_PLAY , XBMCK_MEDIA_PLAY_PAUSE },
  { XBMC_AKEYCODE_MEDIA_EJECT, XBMCK_EJECT },
};
