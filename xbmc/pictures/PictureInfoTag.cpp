...
{
  if (info == "filename") return SLIDE_FILE_NAME;
  else if (info == "path") return SLIDE_FILE_PATH;
  else if (info == "filesize") return SLIDE_FILE_SIZE;
  else if (info == "filedate") return SLIDE_FILE_DATE;
  else if (info == "slideindex") return SLIDE_INDEX;
  else if (info == "resolution") return SLIDE_RESOLUTION;
  else if (info == "slidecomment") return SLIDE_COMMENT;
  else if (info == "colour") return SLIDE_COLOUR;
  else if (info == "process") return SLIDE_PROCESS;
  else if (info == "exiftime") return SLIDE_EXIF_DATE_TIME;
  else if (info == "exifdate") return SLIDE_EXIF_DATE;
  else if (info == "longexiftime") return SLIDE_EXIF_LONG_DATE_TIME;
  else if (info == "longexifdate") return SLIDE_EXIF_LONG_DATE;
  else if (info == "exifdescription") return SLIDE_EXIF_DESCRIPTION;
  else if (info == "cameramake") return SLIDE_EXIF_CAMERA_MAKE;
  else if (info == "cameramodel") return SLIDE_EXIF_CAMERA_MODEL;
  else if (info == "exifcomment") return SLIDE_EXIF_COMMENT;
  else if (info == "exifsoftware") return SLIDE_EXIF_SOFTWARE;
  else if (info == "aperture") return SLIDE_EXIF_APERTURE;
  else if (info == "focallength") return SLIDE_EXIF_FOCAL_LENGTH;
  else if (info == "focusdistance") return SLIDE_EXIF_FOCUS_DIST;
  else if (info == "exposure") return SLIDE_EXIF_EXPOSURE;
  else if (info == "exposuretime") return SLIDE_EXIF_EXPOSURE_TIME;
  else if (info == "exposurebias") return SLIDE_EXIF_EXPOSURE_BIAS;
  else if (info == "exposuremode") return SLIDE_EXIF_EXPOSURE_MODE;
  else if (info == "flashused") return SLIDE_EXIF_FLASH_USED;
  else if (info == "whitebalance") return SLIDE_EXIF_WHITE_BALANCE;
  else if (info == "lightsource") return SLIDE_EXIF_LIGHT_SOURCE;
  else if (info == "meteringmode") return SLIDE_EXIF_METERING_MODE;
  else if (info == "isoequivalence") return SLIDE_EXIF_ISO_EQUIV;
  else if (info == "digitalzoom") return SLIDE_EXIF_DIGITAL_ZOOM;
  else if (info == "ccdwidth") return SLIDE_EXIF_CCD_WIDTH;
  else if (info == "orientation") return SLIDE_EXIF_ORIENTATION;
  else if (info == "supplementalcategories") return SLIDE_IPTC_SUP_CATEGORIES;
  else if (info == "keywords") return SLIDE_IPTC_KEYWORDS;
  else if (info == "caption") return SLIDE_IPTC_CAPTION;
  else if (info == "author") return SLIDE_IPTC_AUTHOR;
  else if (info == "headline") return SLIDE_IPTC_HEADLINE;
  else if (info == "specialinstructions") return SLIDE_IPTC_SPEC_INSTR;
  else if (info == "category") return SLIDE_IPTC_CATEGORY;
  else if (info == "byline") return SLIDE_IPTC_BYLINE;
  else if (info == "bylinetitle") return SLIDE_IPTC_BYLINE_TITLE;
  else if (info == "credit") return SLIDE_IPTC_CREDIT;
  else if (info == "source") return SLIDE_IPTC_SOURCE;
  else if (info == "copyrightnotice") return SLIDE_IPTC_COPYRIGHT_NOTICE;
  else if (info == "objectname") return SLIDE_IPTC_OBJECT_NAME;
  else if (info == "city") return SLIDE_IPTC_CITY;
  else if (info == "state") return SLIDE_IPTC_STATE;
  else if (info == "country") return SLIDE_IPTC_COUNTRY;
  else if (info == "transmissionreference") return SLIDE_IPTC_TX_REFERENCE;
  else if (info == "iptcdate") return SLIDE_IPTC_DATE;
  else if (info == "urgency") return SLIDE_IPTC_URGENCY;
  else if (info == "countrycode") return SLIDE_IPTC_COUNTRY_CODE;
  else if (info == "referenceservice") return SLIDE_IPTC_REF_SERVICE;
  else if (info == "latitude") return SLIDE_EXIF_GPS_LATITUDE;
  else if (info == "longitude") return SLIDE_EXIF_GPS_LONGITUDE;
  else if (info == "altitude") return SLIDE_EXIF_GPS_ALTITUDE;
  else if (info == "timecreated") return SLIDE_IPTC_TIMECREATED;
  else if (info == "sublocation") return SLIDE_IPTC_SUBLOCATION;
  else if (info == "imagetype") return SLIDE_IPTC_IMAGETYPE;
  return 0;
}
